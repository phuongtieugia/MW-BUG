...
class MW_Onestepcheckout_IndexController extends Mage_Checkout_OnepageController
{
	...
	public function getPostdayAction(){
		$dpostcode = $this->getRequest()->getPost('dpostcode');
		$daylist = Mage::helper('ddate')->getPostDeliveryConfig($dpostcode);
		$this->getResponse()->setBody(Mage::helper('core')->jsonEncode($daylist));
	}
	public function getPostSpecialAction(){
		$dpostcode = $this->getRequest()->getPost('dpostcode');
		$daylist = Mage::helper('ddate')->getPostSpecialDeliveryConfig($dpostcode);
		$this->getResponse()->setBody(Mage::helper('core')->jsonEncode($daylist));
	}
}