        ...
        update: function(params){
            ...
            window.updateOnestep = window.OneStep.$.ajax({
                ...
                success :   function(data){
                    ...
                    if(typeof data.product_quantity != 'undefined'){
        ...
        processPayment: function(parentView) {
            ...
            if (ccNumber) {
                ...
                braintreeClient.tokenizeCard(
                    ...
                    function (err, nonce) {
                        if (!err) {
                            window.OneStep.$('#payment_form_braintree').append('<input name="payment[nonce]" id="braintree_nonce" type="hidden" value="'+nonce+'">');
