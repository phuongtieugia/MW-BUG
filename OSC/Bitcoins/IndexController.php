        ...
        public function saveAction()
        {
            ...
            if($post) {
                ...
                foreach ($block_onepage->getItems() as $item) {
					...
					$block_onepage->addItemRender('default', $block_render, $template_render);
					$block_onepage->addItemRender('simple', $block_render, $template_render);
				...
				$html['mwitems_after']=$layout->createBlock('bitcoins/iframe')->setTemplate('bitcoins/iframe.phtml')->toHtml();
				if (!isset($post['payment']['method']) || $post['payment']['method'] != "Bitcoins")
				{
					$html['mwitems_after']="";
				}
                $html              = array(
					...
					'mwitems_after'       => (isset($html['mwitems_after'])) ? $html['mwitems_after'] : "",
