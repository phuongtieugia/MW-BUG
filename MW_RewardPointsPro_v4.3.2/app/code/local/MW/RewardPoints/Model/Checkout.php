    ...
    class MW_RewardPoints_Model_Checkout extends Mage_Core_Model_Abstract
    {
        ...
        protected function perOrder($quote, $order, $multi = false)
        {
            ...
            if($customer->getId())
            {
                ...
                if((sizeof($orders) == 1) && ($friend) && Mage::helper('rewardpoints')->checkCustomerMaxBalance($friend->getCustomerId(), $store_id, $point[0]))
                {
                ...
                else if($friend && Mage::helper('rewardpoints')->checkCustomerMaxBalance($friend->getCustomerId(), $store_id, $point[0]))
                {
