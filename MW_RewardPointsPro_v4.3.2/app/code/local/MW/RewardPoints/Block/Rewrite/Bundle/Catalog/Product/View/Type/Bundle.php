<?php
    ...
    class MW_RewardPoints_Block_Rewrite_Bundle_Catalog_Product_View_Type_Bundle extends Mage_Bundle_Block_Catalog_Product_View_Type_Bundle
    {
        /**
        ...
        public function getJsonConfig()
        {
            ...
            foreach ($optionsArray as $_option)
            {
                ...
                foreach ($_option->getSelections() as $_selection)
                {
                    ...
                    $_product = Mage::getSingleton('catalog/product')->load($_selection->getEntityId());
                    ...
                    $selection = array(
                        ...
                        'sell_point'       => $_product->getData('mw_reward_point_sell_product'),
                        'earn_point'       => $_product->getData('reward_point_product'),
                    );
