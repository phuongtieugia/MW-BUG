 ...
 */
class MW_RewardPoints_Block_Adminhtml_Sales_Order_Create_Totals_Subtotal extends
    Mage_Adminhtml_Block_Sales_Order_Create_Totals_Subtotal
{
     ...
     * @var string
     */
    protected $_template = 'mw_rewardpoints/sales/order/create/totals/rewardpoints_subtotal.phtml';
