<?php
    class MW_RewardPoints_Model_Checkout extends Mage_Core_Model_Abstract
    {
        ...
        {
			$storeID = $argv->getOrder()->getStoreId();
			$_enable = Mage::getStoreConfig('rewardpoints/config/enabled',$storeID);
            if($_enable)
            {
                $order = $argv->getOrder();
                ...
                if($customer->getId()){
                    ...
                    if((sizeof($orders) ==1) && ($friend) && Mage::helper('rewardpoints')->checkCustomerMaxBalance($friend->getCustomerId(),$store_id)){
                    ...
                    }else if($friend && Mage::helper('rewardpoints')->checkCustomerMaxBalance($friend->getCustomerId(),$store_id))
                    {
        ...
        {
            //Mage::log($order->getBaseGrandTotal());
