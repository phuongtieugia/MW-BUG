		...
		$currentp = 0;
            ...
            if($maxPoints)
            {
                ...
                if($customerPoints >= $maxPoints)
                {
                    ...
                    $currentp = $this->roundPoints($points, $store_id, true);
					
					if($maxPoints < $points)
                    {
                        $currentp = $this->roundPoints($maxPoints, $store_id, true);
                    }
                }
                else
                {
					$currentp = $this->roundPoints($points, $store_id, false);
                    if($customerPoints < $points)
                    {
                        $currentp = $this->roundPoints($customerPoints, $store_id, false);
                    }
                }
				...
				$myp = $customerPoints-$total_reward_point; 
				if($myp > 0){
					return $myp;
				}
            }
